...
-- list the top fiften sessions that have the greatest playtime,
...
-- TO DO:
-- analyze the chart in a way that requires to perform simple calaculations to get to a number, what is something that would require this?